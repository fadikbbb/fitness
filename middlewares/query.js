const query = () => {
    return async (req, res, next) => {
        try {
            ...
            req.search = req.query.search ? req.query.search.trim() : null; // If search query is provided
            req.filter = filter;
            req.sortBy = req.query.sort || '';  // Sort parameter
            req.fields = req.query.fields || ''; // Field selection
